...
:: chcp 936
echo off
set projcetname=YS.CoffeeMachine.Platform.API
echo ''
echo '===================================Project YS.CoffeeMachine.Platform.API is ready by release==================================='
echo 'Being released...'
::echo y |del bin 
::echo y |del obj
if exist bin (
...
dotnet publish YS.CoffeeMachine.Platform.API.csproj --configuration Release

echo '===================================Project YS.CoffeeMachine.Platform.API release completed.==================================='
echo '===================================Project YS.CoffeeMachine.Platform.API is ready by build docker images==================================='
docker build -t ys.coffeemachine.platform .
docker tag ys.coffeemachine.platform harbor1.ourvend.com/kfj_p/ys.coffeemachine.platform:k8s
docker push harbor1.ourvend.com/kfj_p/ys.coffeemachine.platform:k8s
docker rmi ys.coffeemachine.platform harbor1.ourvend.com/kfj_p/ys.coffeemachine.platform:k8s
echo '===================================Project YS.CoffeeMachine.Platform.API docker completed.==================================='
::echo '====================================================='
