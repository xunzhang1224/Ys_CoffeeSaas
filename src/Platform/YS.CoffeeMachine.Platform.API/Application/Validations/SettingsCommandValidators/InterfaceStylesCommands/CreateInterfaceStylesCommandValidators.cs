...
namespace YS.CoffeeMachine.Platform.API.Application.Validations.SettingsCommandValidators.InterfaceStylesCommands
{
    /// <summary>
    /// 创建界面样式验证
    /// </summary>
    public class CreateInterfaceStylesCommandValidators : AbstractValidator<CreateInterfaceStylesCommand>
    {
        /// <summary>
        /// 创建界面样式验证
        /// </summary>
        public CreateInterfaceStylesCommandValidators()
        {
