...
namespace YS.CoffeeMachine.Platform.API.Application.CommandHandlers.ApplicationCommandHandlers.ServiceAuthorizationRecordCommandHandlers
{
    ...
    public class CreateServiceAuthorizationRecordCommandHandler(IPServiceAuthorizationRecordRepository repository) : ICommandHandler<CreateServiceAuthorizationRecordCommand, bool>
    {
        /// <summary>
        /// 新增授权
        /// </summary>
