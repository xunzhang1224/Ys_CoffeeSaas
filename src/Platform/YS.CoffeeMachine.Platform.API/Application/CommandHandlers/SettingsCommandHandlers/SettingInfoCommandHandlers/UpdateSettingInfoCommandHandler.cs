...
namespace YS.CoffeeMachine.Platform.API.Application.CommandHandlers.SettingsCommandHandlers.SettingInfoCommandHandlers
{
    ...
    public class UpdateSettingInfoCommandHandler(IPSettingInfoRepository repository, CoffeeMachinePlatformDbContext context) : ICommandHandler<UpdateSettingInfoCommand, bool>
    {
        /// <summary>
        /// 编辑设置信息
        /// </summary>
