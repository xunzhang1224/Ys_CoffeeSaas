...
namespace YS.CoffeeMachine.Platform.API.Application.CommandHandlers.DevicesCommandHandlers.BindDeviceServiceProvidersCommandHandlers
{
    /// <summary>
    /// 设备绑定服务商
    /// </summary>
    /// <param name="context"></param>
    public class BindDeviceServiceProvidersCommandHandler(CoffeeMachinePlatformDbContext context) : ICommandHandler<BindDeviceServiceProvidersCommand, bool>
    {
        /// <summary>
        /// 设备绑定服务商
        /// </summary>
