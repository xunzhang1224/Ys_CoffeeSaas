...
namespace YS.CoffeeMachine.Platform.API.Application.DomainEventHandlers.BasicEventHandles.Language
{
    ...
    ///// <param name="mediator"></param>
    ///// <param name="_redisClient"></param>
    //public class DelRangeLanguageTextDomainEventHandler(IMediator mediator, IRedisClient _redisClient) : IDomainEventHandler<DelRangeLanguageTextDomainEvent>
    //{
    //    /// <summary>
    //    /// 删除多语言文本
    //    /// </summary>
    ...
    ///// <param name="mediator"></param>
    ///// <param name="_redisClient"></param>
    //public class AddRangeLanguageTextDomainEventHandler(IMediator mediator, IRedisClient _redisClient) : IDomainEventHandler<AddRangeLanguageTextDomainEvent>
    //{
    //    /// <summary>
    //    /// 添加多语言文本
    //    /// </summary>
