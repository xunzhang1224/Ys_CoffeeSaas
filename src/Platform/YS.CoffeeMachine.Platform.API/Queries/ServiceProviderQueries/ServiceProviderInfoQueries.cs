...
namespace YS.CoffeeMachine.Platform.API.Queries.ServiceProviderQueries
{
    /// <summary>
    /// 服务商查询
    /// </summary>
    ...
    public class ServiceProviderInfoQueries(CoffeeMachinePlatformDbContext context, IMapper mapper) : IServiceProviderInfoQueries
    {
        /// <summary>
        /// 获取服务商分页列表
        /// </summary>
