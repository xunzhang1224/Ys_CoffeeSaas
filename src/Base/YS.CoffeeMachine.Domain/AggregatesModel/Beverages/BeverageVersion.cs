namespace YS.CoffeeMachine.Domain.AggregatesModel.Beverages
{
    ...
    /// 饮品版本
    /// </summary>
    public class BeverageVersion : BaseEntity
    {
        /// <summary>
        /// 饮品Id
        /// </summary>
        ...
        public BeverageVersion(long beverageInfoId, BeverageVersionTypeEnum versionType, string beverageInfoDataString, long? id = null)
        {
