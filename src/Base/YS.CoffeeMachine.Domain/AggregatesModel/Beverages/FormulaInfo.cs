...
namespace YS.CoffeeMachine.Domain.AggregatesModel.Beverages
{
    ...
    /// 配方信息
    /// </summary>
    public class FormulaInfo : BaseEntity
    {
        /// <summary>
        /// 饮品Id
        /// </summary>
        ...
        public FormulaInfo(long beverageInfoId, long? materialBoxId, string materialBoxName, int sort, FormulaTypeEnum formulaType, JsonObject specs)
        {
        ...
        public FormulaInfo(long beverageInfoId, long? materialBoxId, string materialBoxName, int sort, FormulaTypeEnum formulaType, string msg)
        {
            BeverageInfoId = beverageInfoId;
            MaterialBoxId = materialBoxId;
            MaterialBoxName = materialBoxName;
