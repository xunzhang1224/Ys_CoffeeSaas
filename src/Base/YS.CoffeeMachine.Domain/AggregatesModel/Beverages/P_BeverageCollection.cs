namespace YS.CoffeeMachine.Domain.AggregatesModel.Beverages
{
    ...
    public class P_BeverageCollection : BaseEntity, IAggregateRoot
    {
        /// <summary>
        /// 语言字典key
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        protected P_BeverageCollection() { }
        ...
        public P_BeverageCollection(string languageKey, long deviceModelId, string name, string beverageIds, string beverageNames)
        {
