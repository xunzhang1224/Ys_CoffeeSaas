...
namespace YS.CoffeeMachine.Infrastructure.Repositories.BeveragesRepositorys
{
    ...
    public class SysLanguageEntityRepository(CoffeeMachineDbContext context) : YsRepositoryBase<BeverageInfo, long, CoffeeMachineDbContext>(context), IBeverageInfoRepository
    {
    }
}
