...
namespace YS.CoffeeMachine.Infrastructure.Repositories.SettingsRepositories
{
    ...
    /// 界面样式
    /// </summary>
    public class InterfaceStylesRepository(CoffeeMachineDbContext context) : YsRepositoryBase<InterfaceStyles, long, CoffeeMachineDbContext>(context), IInterfaceStylesRepository
    {
    }
}
