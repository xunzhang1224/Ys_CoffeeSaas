...
namespace YS.CoffeeMachine.Infrastructure.Repositories.Basics.Language
{
    ...
    public class LanguageInfoRepository(CoffeeMachineDbContext context) : YsRepositoryBase<LanguageInfo, CoffeeMachineDbContext>(context), ILanguageInfoRepository
    {
        /// <summary>
        /// 获取默认语种
        /// </summary>
