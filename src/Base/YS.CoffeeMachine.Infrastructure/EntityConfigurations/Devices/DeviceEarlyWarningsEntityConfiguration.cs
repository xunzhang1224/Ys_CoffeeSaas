...
namespace YS.CoffeeMachine.Infrastructure.EntityConfigurations.Devices
{
    ...
    /// a
    /// </summary>
    public class DeviceEarlyWarningsEntityConfiguration : IEntityTypeConfiguration<DeviceEarlyWarnings>
    {
        /// <summary>
        /// a
        /// </summary>
        /// <param name="builder"></param>
        public void Configure(EntityTypeBuilder<DeviceEarlyWarnings> builder)
        {
            builder.ToTable("DeviceEarlyWarnings");
