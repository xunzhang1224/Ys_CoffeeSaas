...
namespace YS.CoffeeMachine.Infrastructure.EntityConfigurations.Devices
{
    ...
    /// 设备软件信息
    /// </summary>
    public class GropuDevicesEntityConfiguration : IEntityTypeConfiguration<GroupDevices>
    {
        /// <summary>
        /// 配置
        /// </summary>
        /// <param name="eb"></param>
        public void Configure(EntityTypeBuilder<GroupDevices> eb)
        {
            eb.ToTable("GroupDevices");
            eb.HasKey(t => t.Id);
