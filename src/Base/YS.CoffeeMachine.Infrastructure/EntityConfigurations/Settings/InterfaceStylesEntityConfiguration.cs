...
namespace YS.CoffeeMachine.Infrastructure.EntityConfigurations.Settings
{
    ...
    /// 接口样式
    /// </summary>
    public class InterfaceStylesEntityConfiguration : IEntityTypeConfiguration<InterfaceStyles>
    {
        /// <summary>
        /// 配置
        /// </summary>
        /// <param name="eb"></param>
        public void Configure(EntityTypeBuilder<InterfaceStyles> eb)
        {
            eb.ToTable("InterfaceStyles");
            eb.HasKey(t => t.Id);
            ...
            eb.Property(t => t.Preview).IsRequired();
        }
    }
}
