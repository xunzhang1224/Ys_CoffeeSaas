...
namespace YS.CoffeeMachine.Infrastructure.EntityConfigurations.ApplicationUsers
{
    ...
    /// 企业角色
    /// </summary>
    public class EnterpriseRoleEntityConfiguration : IEntityTypeConfiguration<EnterpriseRole>
    {
        /// <summary>
        /// 配置
        /// </summary>
        /// <param name="eb"></param>
        public void Configure(EntityTypeBuilder<EnterpriseRole> eb)
        {
            eb.ToTable("EnterpriseRole");
            eb.HasKey(t => t.Id);
