...
namespace YS.CoffeeMachine.Infrastructure.PlatformRepositories.ApplicationUsersRepositories
{
    ...
    /// 角色信息仓储
    /// </summary>
    public class PApplicationUserRepository(CoffeeMachinePlatformDbContext context) : YsRepositoryBase<ApplicationUser, long, CoffeeMachinePlatformDbContext>(context), IPApplicationUserRepository
    {
        /// <summary>
        /// 根据Id查询用户信息
        /// </summary>
