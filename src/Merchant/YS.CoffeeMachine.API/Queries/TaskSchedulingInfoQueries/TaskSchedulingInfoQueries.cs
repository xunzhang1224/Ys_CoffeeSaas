...
namespace YS.CoffeeMachine.API.Queries.TaskSchedulingInfoQueries
{
    /// <summary>
    /// 任务调度相关查询
    /// </summary>
    ...
    public class TaskSchedulingInfoQueries(CoffeeMachineDbContext context, IMapper mapper) : ITaskSchedulingInfoQueries
    {
        /// <summary>
        /// 通过Id获取任务调度信息
        /// </summary>
