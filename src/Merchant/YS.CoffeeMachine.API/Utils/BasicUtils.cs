...
namespace YS.CoffeeMachine.API.Utils
{
    ...
    public static class BasicUtils
    {
        ...
        /// <param name="no"></param>
        /// <returns></returns>
        public static string ToEventLangKey(this string no)
        {
            return IotConst.LangKeyForEventNo + no;
        }
        ...
        {
            // 生成订单号
            return string.Format(CacheConst.OrderCode, DateTime.Now.ToString("yyyyMMddHHmm")) + YitIdHelper.NextId();
        }
    }
}
