...
namespace YS.CoffeeMachine.API.Application.Services
{
    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        public Task<List<EnumInfo>> GetAllEnumInfos()
        {
            ...
            typeof(OrderShipmentResult),typeof(OrderSaleResult),typeof(PaymentEnum),typeof(PayTypeEnum),typeof(PaymentConfigStatueEnum),typeof(PaymentCurrencyLocatonEnum),typeof(DocmentTypeEnum),typeof(EnterpriseOrganizationTypeEnum),
                typeof(RegistrationProgress),typeof(InternalOnboardingStatusEnum),typeof(IsDefaultEnum),typeof(MerchantTypeEnum),typeof(LegalCertTypeEnum),typeof(ApplymentFlowStatusEnum),typeof(ArtificialApplymentEnum),typeof(WxApplymentIdentityCertTypeEnum),typeof(WxApplymentSubjectTypeEnum),typeof(WxApplymentStateEnum),typeof(PaymentPlatformTypeEnum),typeof(RestockTypeEnum),typeof(FlushComponentTypeEnum),typeof(OrderStatusEnum),
                typeof(OrderDetailRerundStatusEnum),typeof(WxProfitSharingRelationTypeEnum),typeof(WxProfitSharingReceiverTypeEnum),typeof(ProductCategoryTypeEnum)];
        ...
        public static TEnum GetEnumByDescription<TEnum>(string description) where TEnum : Enum
        {
            ...
            throw ExceptionHelper.AppFriendly(string.Format(L.Text[nameof(ErrorCodeEnum.D0073)], description));
        }
