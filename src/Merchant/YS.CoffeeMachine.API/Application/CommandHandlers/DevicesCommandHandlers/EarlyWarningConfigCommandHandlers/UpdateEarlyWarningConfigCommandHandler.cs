...
namespace YS.CoffeeMachine.API.Application.CommandHandlers.DevicesCommandHandlers.EarlyWarningConfigCommandHandlers
{
    /// <summary>
    /// 更新预警配置
    /// </summary>
    /// <param name="context"></param>
    public class UpdateEarlyWarningConfigCommandHandler(CoffeeMachineDbContext context) : ICommandHandler<UpdateEarlyWarningConfigCommand, bool>
    {
        /// <summary>
        /// 更新预警配置
        /// </summary>
