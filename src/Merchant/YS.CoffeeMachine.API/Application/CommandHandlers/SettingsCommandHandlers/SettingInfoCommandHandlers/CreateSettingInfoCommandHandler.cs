...
namespace YS.CoffeeMachine.API.Application.CommandHandlers.SettingsCommandHandlers.SettingInfoCommandHandlers
{
    ...
    public class CreateSettingInfoCommandHandler(ISettingInfoRepository repository, CoffeeMachineDbContext context) : ICommandHandler<CreateSettingInfoCommand, bool>
    {
        /// <summary>
        /// 添加设置信息
        /// </summary>
