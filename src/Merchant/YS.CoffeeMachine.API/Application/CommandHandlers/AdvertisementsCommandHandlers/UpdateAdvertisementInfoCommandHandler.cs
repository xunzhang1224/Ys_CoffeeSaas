...
namespace YS.CoffeeMachine.API.Application.CommandHandlers.AdvertisementsCommandHandlers
{
    ...
    public class UpdateAdvertisementInfoCommandHandler(IAdvertisementsRepository repository, CoffeeMachineDbContext dbContext) : ICommandHandler<UpdateAdvertisementInfoCommand, bool>
    {
        /// <summary>
        /// 编辑广告信息
        /// </summary>
