...
namespace YS.CoffeeMachine.API.Application.CommandHandlers.AdvertisementsCommandHandlers
{
    ...
    public class CreateAdvertisementInfoCommandHandler(CoffeeMachineDbContext context) : ICommandHandler<CreateAdvertisementInfoCommand, bool>
    {
        /// <summary>
        /// 添加广告信息
        /// </summary>
        ...
        public async Task<bool> Handle(CreateAdvertisementInfoCommand request, CancellationToken cancellationToken)
        {
            ...
            if (deviceInfo.SettingInfo != null)
                throw ExceptionHelper.AppFriendly(L.Text[nameof(ErrorCodeEnum.D0010)]);
