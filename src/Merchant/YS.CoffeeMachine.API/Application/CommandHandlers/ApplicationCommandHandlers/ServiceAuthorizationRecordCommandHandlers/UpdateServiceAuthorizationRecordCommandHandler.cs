...
namespace YS.CoffeeMachine.API.Application.CommandHandlers.ApplicationCommandHandlers.ServiceAuthorizationRecordCommandHandlers
{
    ...
    public class UpdateServiceAuthorizationRecordCommandHandler(IServiceAuthorizationRecordRepository repository) : ICommandHandler<UpdateServiceAuthorizationRecordCommand, bool>
    {
        /// <summary>
        /// 更改服务授权状态
        /// </summary>
