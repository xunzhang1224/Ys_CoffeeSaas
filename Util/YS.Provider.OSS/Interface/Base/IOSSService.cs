namespace YS.Provider.OSS.Interface.Base
{
    ...
    public interface IOSSService
    {
        ...
        /// <returns></returns>
        Task<bool> SetObjectAclAsync(string bucketName, string objectName, AccessModeEnum mode);
        ...
        /// <param name="objectName"></param>
        /// <returns></returns>
        Task<AccessModeEnum> GetObjectAclAsync(string bucketName, string objectName);
        ...
        /// <param name="objectName"></param>
        /// <returns></returns>
        Task<AccessModeEnum> RemoveObjectAclAsync(string bucketName, string objectName);
    }
}
